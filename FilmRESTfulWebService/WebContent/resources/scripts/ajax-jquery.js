$(document).ready(function() {
	...
	$("#get-all-films-form").submit(function(e) {
		...
		ajax("GET", targetURL, null, null, formatType,
						function(data) {
							console.log(data);
	...
	$("#get-film-form").submit(function(e) {
		...
		// Get the targetURL for the server from the forms action attribute
		var targetURL = $(this).attr("action") + inputField;
	...
	$("#update-form").submit(function(e) {
		...
		// Get target url and append film id to it
		var filmID = filmForm[1].value;
		var targetURL = $(this).attr("action") + filmID;
