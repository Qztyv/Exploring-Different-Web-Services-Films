...
public class FilmTraditionalDAO {
	...
	public Film[] getAllFilms() {
		...
		return allFilms.toArray(new Film[0]);
	}
	...
	public Film[] getAllFilmsByTitle(String searchName) {
		...
		return allFilmsByTitle.toArray(new Film[0]);
	}
